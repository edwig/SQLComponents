...
-- NORTHWIND DATABASE
--
-- Oracle implementation of the Microsoft NorthWind example DATABASE
--
----------------------------------------------------------------------
...
DROP TABLE "Order Details" CASCADE CONSTRAINT;
DROP TABLE "Region"        CASCADE CONSTRAINT;
DROP TABLE "Territories"   CASCADE CONSTRAINT;
DROP TABLE "US_States"     CASCADE CONSTRAINT;
DROP TABLE "CustomerCustomerDemo"  CASCADE CONSTRAINT;
DROP TABLE "CustomerDemographics"  CASCADE CONSTRAINT;

DROP TRIGGER northwind."Trg_Emp_BirthDate";

DROP SEQUENCE "SEQ_nw_categories";
DROP SEQUENCE "SEQ_nw_customers";
DROP SEQUENCE "SEQ_nw_emmployees";
...
COMMENT ON COLUMN northwind."Categories"."CategoryID"   IS 'Number automatically assigned to a new category.';
COMMENT ON COLUMN northwind."Categories"."CategoryName" IS 'Name of food category.';
...
COMMENT ON COLUMN northwind."Customers"."CustomerID" IS 'Unique five-character code based on customer name.';
...
COMMENT ON COLUMN northwind."Employees"."EmployeeID"      IS 'Number automatically assigned to new employee.';
COMMENT ON COLUMN northwind."Employees"."Title"           IS 'Employee''s title.';
COMMENT ON COLUMN northwind."Employees"."TitleOfCourtesy" IS 'Title used in salutations.';
...
COMMENT ON COLUMN northwind."Employees"."HomePhone"       IS 'Phone number includes country code or area code.';
...
COMMENT ON COLUMN northwind."Employees"."ReportsTo"       IS 'Employee''s supervisor.';
...
COMMENT ON COLUMN northwind."Suppliers"."SupplierID" IS 'Number automatically assigned to new supplier.';
...
COMMENT ON COLUMN northwind."Suppliers"."HomePage"   IS 'Supplier''s home page on World Wide Web.';
...
COMMENT ON COLUMN northwind."Shippers"."ShipperID"   IS 'Number automatically assigned to new shipper.';
COMMENT ON COLUMN northwind."Shippers"."CompanyName" IS 'Name of shipping company.';
...
COMMENT ON COLUMN northwind."Products"."ProductID"       IS 'Number automatically assigned to new product.';
COMMENT ON COLUMN northwind."Products"."SupplierID"      IS 'Same entry as in Suppliers table.';
COMMENT ON COLUMN northwind."Products"."CategoryID"      IS 'Same entry as in Categories table.';
COMMENT ON COLUMN northwind."Products"."QuantityPerUnit" IS '(e.g., 24-count case, 1-liter bottle).';
COMMENT ON COLUMN northwind."Products"."ReorderLevel"    IS 'Minimum units to maintain in stock.';
...
COMMENT ON COLUMN northwind."Orders"."OrderID"     IS 'Unique order number.';
COMMENT ON COLUMN northwind."Orders"."CustomerID"  IS 'Same entry as in Customers table.';
COMMENT ON COLUMN northwind."Orders"."EmployeeID"  IS 'Same entry as in Employees table.';
COMMENT ON COLUMN northwind."Orders"."ShipVia"     IS 'Same as Shipper ID in Shippers table.';
COMMENT ON COLUMN northwind."Orders"."ShipName"    IS 'Name of person or company to receive the shipment.';
COMMENT ON COLUMN northwind."Orders"."ShipAddress" IS 'Street address only -- no post-office box allowed.';
COMMENT ON COLUMN northwind."Orders"."ShipRegion"  IS 'State or province.';
...
COMMENT ON COLUMN northwind."Order Details"."OrderID"   IS 'Same as Order ID in Orders table.';
COMMENT ON COLUMN northwind."Order Details"."ProductID" IS 'Same as Product ID in Products table.';
...
INSERT INTO northwind."Customers"
   ("CustomerID", "CustomerCode","CompanyName","ContactName","ContactTitle","Address","City","PostalCode","Country","Phone","Fax")
 Values
...
INSERT INTO northwind."Customers"
   ("CustomerID", "CustomerCode","CompanyName","ContactName","ContactTitle","Address","City","PostalCode","Country","Phone")
 Values
...
INSERT INTO northwind."Customers"
   ("CustomerID", "CustomerCode","CompanyName","ContactName","ContactTitle","Address","City","Region","PostalCode","Country","Phone")
 Values
...
INSERT INTO northwind."Customers"
   ("CustomerID", "CustomerCode","CompanyName","ContactName","ContactTitle","Address","City","Region","Country","Phone","Fax")
 Values
...
INSERT INTO northwind."Customers"
   ("CustomerID", "CustomerCode","CompanyName","ContactName","ContactTitle","Address","City","Region","PostalCode","Country","Phone","Fax")
 Values
   (75, 'SPLIR', 'Split Rail Beer and Ale', 'Art Braunschweiger', 'Sales Manager',
...
Insert into "Suppliers"("SupplierID", "CompanyName", "ContactName", "ContactTitle", "Address", "City", "PostalCode", "Country", "Phone")
Values(11, 'Heli Süßwaren GmbH and Co. KG', 'Petra Winkler', 'Sales Manager', 'Tiergartenstraße 5', 'Berlin', '10785', 'Germany', '(010) 9984510');
...
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10502, 58, 2, TO_DATE('04/10/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('05/08/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    ...
    'México D.F.', '05033', 'Mexico');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipRegion","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10271, 75, 6, TO_DATE('08/01/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('08/29/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    TO_DATE('08/30/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 2, 4.54, 'Split Rail Beer and Ale', 'P.O. Box 555',
    'Lander', 'WY', '82520', 'USA');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipRegion","ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10329, 75, 4, TO_DATE('10/15/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('11/26/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    TO_DATE('10/23/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 2, 191.67, 'Split Rail Beer and Ale', 'P.O. Box 555',
    'Lander', 'WY', '82520', 'USA');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipRegion","ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10349, 75, 7, TO_DATE('11/08/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('12/06/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    TO_DATE('11/15/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 1, 8.63, 'Split Rail Beer and Ale', 'P.O. Box 555',
    'Lander', 'WY', '82520', 'USA');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10369, 75, 8, TO_DATE('12/02/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('12/30/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    TO_DATE('12/09/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 2, 195.68, 'Split Rail Beer and Ale', 'P.O. Box 555',
    'Lander', 'WY', '82520', 'USA');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10385, 75, 1, TO_DATE('12/17/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('01/14/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    TO_DATE('12/23/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 2, 30.96, 'Split Rail Beer and Ale', 'P.O. Box 555',
    'Lander', 'WY', '82520', 'USA');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipRegion","ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10432, 75, 3, TO_DATE('01/31/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('02/14/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    TO_DATE('02/07/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 2, 4.34, 'Split Rail Beer and Ale', 'P.O. Box 555',
    'Lander', 'WY', '82520', 'USA');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (11038, 76, 1, TO_DATE('04/21/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('05/19/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    ...
    'Charleroi', 'B-6000', 'Belgium');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipRegion","ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10756, 75, 8, TO_DATE('11/27/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('12/25/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    TO_DATE('12/02/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 2, 73.21, 'Split Rail Beer and Ale', 'P.O. Box 555',
    'Lander', 'WY', '82520', 'USA');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipRegion","ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10821, 75, 1, TO_DATE('01/08/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('02/05/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    TO_DATE('01/15/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 1, 36.68, 'Split Rail Beer and Ale', 'P.O. Box 555',
    'Lander', 'WY', '82520', 'USA');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipRegion","ShipPostalCode","ShipCountry")
 Values
...
INSERT INTO "Orders"
 ...
 Values
   (10974, 75, 3, TO_DATE('03/25/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('04/08/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
    TO_DATE('04/03/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 3, 12.96, 'Split Rail Beer and Ale', 'P.O. Box 555',
    'Lander', 'WY', '82520', 'USA');
INSERT INTO "Orders"
   ("OrderID","CustomerID", "EmployeeID","OrderDate", "RequiredDate","ShippedDate", "ShipVia","Freight","ShipName", "ShipAddress","ShipCity", "ShipRegion","ShipPostalCode","ShipCountry")
 Values
...
CREATE UNIQUE INDEX "UIDX_CategoryName"  ON northwind."Categories"("CategoryName");
CREATE UNIQUE INDEX "UIDX_CustomersCode" ON northwind."Customers"("CustomerCode");
CREATE INDEX "IDX_CustomersCity"         ON northwind."Customers"("City");
CREATE INDEX "IDX_CustomersCompanyName"  ON northwind."Customers"("CompanyName");
CREATE INDEX "IDX_CustomersPostalCode"   ON northwind."Customers"("PostalCode");
CREATE INDEX "IDX_CustomersRegion"       ON northwind."Customers"("Region");
CREATE INDEX "IDX_EmployeesLastName"     ON northwind."Employees"("LastName");
CREATE INDEX "IDX_EmployeesPostalCode"   ON northwind."Employees"("PostalCode");
CREATE INDEX "IDX_SuppliersCompanyName"  ON northwind."Suppliers"("CompanyName");
CREATE INDEX "IDX_SuppliersPostalCode"   ON northwind."Suppliers"("PostalCode");
CREATE INDEX "IDX_ProductsCategoryID"    ON northwind."Products" ("CategoryID");
CREATE INDEX "IDX_ProductsSupplierID"    ON northwind."Products" ("SupplierID");
CREATE INDEX "IDX_OrdersCustomerID"      ON northwind."Orders"("CustomerID");
CREATE INDEX "IDX_OrdersEmployeeID"      ON northwind."Orders"("EmployeeID");
CREATE INDEX "IDX_OrdersShipperID"       ON northwind."Orders"("ShipVia");
CREATE INDEX "IDX_OrdersOrderDate"       ON northwind."Orders"("OrderDate");
CREATE INDEX "IDX_OrdersShippedDate"     ON northwind."Orders"("ShippedDate");
CREATE INDEX "IDX_OdersShipPostalCode"   ON northwind."Orders"("ShipPostalCode");
CREATE INDEX "IDX_OrderDetailsOrderID"   ON northwind."Order Details"("OrderID");
CREATE INDEX "IDX_OrderDetailsProductID" ON northwind."Order Details"("ProductID");

--/******************************************************************************/
--/***                              Primary keys                              ***/
--/******************************************************************************/

ALTER TABLE northwind."Categories"           ADD CONSTRAINT "PK_Categories"           PRIMARY KEY ("CategoryID");
ALTER TABLE northwind."CustomerCustomerDemo" ADD CONSTRAINT "PK_CustomerCustomerDemo" PRIMARY KEY ("CustomerID", "CustomerTypeID");
ALTER TABLE northwind."CustomerDemographics" ADD CONSTRAINT "PK_CustomerDemographics" PRIMARY KEY ("CustomerTypeID");
ALTER TABLE northwind."Customers"            ADD CONSTRAINT "PK_Customers"            PRIMARY KEY ("CustomerID");
ALTER TABLE northwind."Employees"            ADD CONSTRAINT "PK_Employees"            PRIMARY KEY ("EmployeeID");
ALTER TABLE northwind."Order Details"        ADD CONSTRAINT "PK_Order Details"        PRIMARY KEY ("OrderID", "ProductID");
ALTER TABLE northwind."Orders"               ADD CONSTRAINT "PK_Orders"               PRIMARY KEY ("OrderID");
ALTER TABLE northwind."Products"             ADD CONSTRAINT "PK_Products"             PRIMARY KEY ("ProductID");
ALTER TABLE northwind."Region"               ADD CONSTRAINT "PK_Region"               PRIMARY KEY ("RegionID");
ALTER TABLE northwind."Shippers"             ADD CONSTRAINT "PK_Shippers"             PRIMARY KEY ("ShipperID");
ALTER TABLE northwind."Suppliers"            ADD CONSTRAINT "PK_Suppliers"            PRIMARY KEY ("SupplierID");
ALTER TABLE northwind."Territories"          ADD CONSTRAINT "PK_Territories"          PRIMARY KEY ("TerritoryID");

--/******************************************************************************/
--/***                              Foreign keys                              ***/
--/******************************************************************************/

ALTER TABLE northwind."CustomerCustomerDemo" ADD CONSTRAINT "FK_CustomerCustomerDemo"            FOREIGN KEY ("CustomerTypeID") REFERENCES northwind."CustomerDemographics" ("CustomerTypeID");
--ALTER TABLE northwind."CustomerCustomerDemo" ADD CONSTRAINT "FK_CustomerCustomerDemo_Customers"  FOREIGN KEY ("CustomerID")     REFERENCES northwind."Customers" ("CustomerID");
...
ALTER TABLE northwind."Order Details"        ADD CONSTRAINT "FK_Order_Details_Orders"            FOREIGN KEY ("OrderID")        REFERENCES northwind."Orders" ("OrderID");
ALTER TABLE northwind."Order Details"        ADD CONSTRAINT "FK_Order_Details_Products"          FOREIGN KEY ("ProductID")      REFERENCES northwind."Products" ("ProductID");
ALTER TABLE northwind."Orders"               ADD CONSTRAINT "FK_Orders_Customers"                FOREIGN KEY ("CustomerID")     REFERENCES northwind."Customers" ("CustomerID");
ALTER TABLE northwind."Orders"               ADD CONSTRAINT "FK_Orders_Employees"                FOREIGN KEY ("EmployeeID")     REFERENCES northwind."Employees" ("EmployeeID");
ALTER TABLE northwind."Orders"               ADD CONSTRAINT "FK_Orders_Shippers"                 FOREIGN KEY ("ShipVia")        REFERENCES northwind."Shippers" ("ShipperID");
ALTER TABLE northwind."Products"             ADD CONSTRAINT "FK_Products_Categories"             FOREIGN KEY ("CategoryID")     REFERENCES northwind."Categories" ("CategoryID");
ALTER TABLE northwind."Products"             ADD CONSTRAINT "FK_Products_Suppliers"              FOREIGN KEY ("SupplierID")     REFERENCES northwind."Suppliers" ("SupplierID");
ALTER TABLE northwind."Territories"          ADD CONSTRAINT "FK_Territories_Region"              FOREIGN KEY ("RegionID")       REFERENCES northwind."Region" ("RegionID");
...
ALTER TABLE northwind."Products"
  ADD CONSTRAINT "CK_Products_UnitsOnOrder" CHECK ("UnitsOnOrder" >= 0);
ALTER TABLE northwind."Products"
  ADD CONSTRAINT "CK_Products_ReorderLevel" CHECK ("ReorderLevel" >= 0);
ALTER TABLE northwind."Products"
  ADD CONSTRAINT "CK_Products_Discontintued" CHECK ("Discontinued" IN ('Y','N'));
ALTER TABLE northwind."Order Details"
  ADD CONSTRAINT "CK_OrderDetailsUnitPrice" CHECK ("UnitPrice" >= 0);
ALTER TABLE northwind."Order Details"
  ADD CONSTRAINT "CK_OrderDetailsQuantity" CHECK ("Quantity" >= 0);
ALTER TABLE northwind."Order Details"
  ADD CONSTRAINT "CK_OrderDetailsDiscount" CHECK ("Discount" BETWEEN 0 AND 1);

-- Create a trigger to validate employee birthdate.
CREATE OR REPLACE TRIGGER northwind."Trg_Emp_BirthDate"
